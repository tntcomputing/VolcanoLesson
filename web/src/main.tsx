...
const stations: Station[] = [
  { id: "A", locationId: "A", name: "Ash Camp", position: { left: "20%", top: "70%" } },
  { id: "B", locationId: "B", name: "Lava Post", position: { left: "67%", top: "70%" } },
  { id: "C", locationId: "C", name: "South Camp", position: { left: "54%", top: "79%" } },
  { id: "D", locationId: "D", name: "West Peak", position: { left: "65%", top: "62%" } },
  { id: "E", locationId: "E", name: "Sky Radar", position: { left: "50%", top: "12%" } },
  { id: "F", locationId: "F", name: "Enid Camp", position: { left: "45%", top: "55%" } },
  { id: "G", locationId: "G", name: "Magma Hut", position: { left: "63%", top: "43%" } },
  { id: "H", locationId: "H", name: "Cinder Pt", position: { left: "37%", top: "78%" } },
  { id: "I", locationId: "I", name: "Glow Camp", position: { left: "47%", top: "45%" } },
  { id: "J", locationId: "J", name: "Peak Out", position: { left: "57%", top: "50%" } },
